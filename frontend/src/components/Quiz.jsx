      ...
      <div className="max-w-2xl mx-auto">
        ...
        {!started && (
          <div className="text-center py-16">
            ...
            <p className="text-gray-400 mb-6">Test your knowledge with AI-generated questions</p>
              ...
              {Object.entries(quiz[current].options).map(([key, value]) => (
                <div key={key} onClick={() => handleSelect(key)}
                  ...
                  <span className={`text-sm font-bold w-6 h-6 rounded-full flex items-center justify-center
                    border ${selected ? "border-current" : "border-gray-600"}`}>
                    {key}
                  </span>
                  ...
                  {selected && key === selected && key !== quiz[current].answer && (
        ...
        {finished && (
          <div className="text-center">
            ...
            <div className="text-left space-y-3 mb-8">
              {answers.map((a, i) => (
                <div key={i} className={`border rounded-xl p-4 ${a.isCorrect ? "border-green-800 bg-green-950" : "border-red-800 bg-red-950"}`}>
